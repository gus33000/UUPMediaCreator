...
namespace Microsoft.StoreServices.DisplayCatalog
{
    ...
    public class Payload
    {
        ...
        public bool IsDeviceCompanionApp
        {
            get; set;
        }
        ...
        public bool ContainsDownloadPackage
        {
            get; set;
        }
        ...
        public Detailsdisplayconfiguration DetailsDisplayConfiguration
        {
            get; set;
        }
        ...
        public bool HasParentBundles
        {
            get; set;
        }
        public bool HasAlternateEditions
        {
            get; set;
        }
        public Productpartd ProductPartD
        {
            get; set;
        }
        public int VideoProductType
        {
            get; set;
        }
        public bool IsMsixvc
        {
            get; set;
        }
        public Image[] Images
        ...
        public bool DeveloperOptOutOfSDCardInstall
        {
            get; set;
        }
        ...
        public bool HideFromCollections
        {
            get; set;
        }
        ...
        public bool HideFromDownloadsAndUpdates
        {
            get; set;
        }
        public bool GamingOptionsXboxLive
        {
            get; set;
        }
        ...
        public Badge1[] Badges
        {
            get; set;
        }
        public bool IsGamingAppOnly
        {
            get; set;
        }
        ...
        public DateTime PromoEndDateUtc
        {
            get; set;
        }
        ...
        public string PublisherCopyrightInformation
        {
            get; set;
        }
        ...
        public Productrating[] ProductRatings
        {
            get; set;
        }
        ...
        public string[] PackageAndDeviceCapabilities
        {
            get; set;
        }
        ...
        public string DeviceFamilyDisallowedReason
        {
            get; set;
        }
        ...
        public Warningmessage[] WarningMessages
        {
            get; set;
        }
        ...
        public Capabilitiestable[] CapabilitiesTable
        {
            get; set;
        }
        ...
        public string AvailableDevicesDisplayText
        {
            get; set;
        }
        public string AvailableDevicesNarratorText
        {
            get; set;
        }
        ...
        public string[] SkuDisplayGroups
        {
            get; set;
        }
        public string[] Notes
        ...
        public string AddOnPriceRange
        {
            get; set;
        }
        public string RecurrencePolicy
        {
            get; set;
        }
        ...
        public bool CapabilityXboxEnhanced
        {
            get; set;
        }
        ...
        public string PlaintextPassName
        {
            get; set;
        }
        public string GlyphTextPassName
        {
            get; set;
        }
        public string SubscriptionDiscountMessageTemplate
        {
            get; set;
        }
        public Primarypackageidentity PrimaryPackageIdentity
        {
            get; set;
        }
    ...
    public class Minimum
    {
        ...
        public string EmptySectionMessage
        {
            get; set;
        }
    }
    ...
    public class Appextension
    {
        ...
        public bool AppWithExt
        {
            get; set;
        }
        public string[] AppExtCategoryNames
        {
            get; set;
        }
        public string[] LocalizedCategoryNames
        {
            get; set;
        }
        public string[] AppExtTypes
        {
            get; set;
        }
        public string[] AppExtTypeStrings
        {
            get; set;
        }
        public string AppExtMessage
        {
            get; set;
        }
    }
    ...
    public class Models
    {
        ...
        public Mixedrealitymodule MixedRealityModule
        {
            get; set;
        }
    }
    ...
    public class Sku
    {
        ...
        public bool IsPaymentInstrumentRequired
        {
            get; set;
        }
        public string MSAPurchaseType
        {
            get; set;
        }
        public int RemainingDaysInTrial
        {
            get; set;
        }
        ...
        public Skudisplayrank[] SkuDisplayRanks
        {
            get; set;
        }
        ...
        public string FulfillmentData
        {
            get; set;
        }
        public FulfillmentData FulfillmentDataDeserialized
        {
            get; set;
        }
        public Packagerequirement[] PackageRequirements
        {
            get; set;
        }
        ...
        public string[] HardwareWarnings
        {
            get; set;
        }
        ...
        public string TimedTrialMessage
        {
            get; set;
        }
        public int DurationInSeconds
        ...
        public string RecurrencePolicyTitle
        {
            get; set;
        }
    ...
    public class Availability
    {
        ...
        public DateTime AvailabilityEndDate
        {
            get; set;
        }
    ...
    public class Clientconditions
    {
        ...
        public Allowedplatform[] AllowedPlatforms
        {
            get; set;
        }
    }
    ...
    public class Remediation
    {
        ...
        public string UpsellProductName
        {
            get; set;
        }
    }
    ...
    public class Badge
    {
        ...
        public string DeferredRequestKey
        {
            get; set;
        }
    ...
    public class Productrating
    {
        ...
        public string RatingSystemShortName
        {
            get; set;
        }
        ...
        public string RatingValueLogoUrl
        {
            get; set;
        }
        ...
        public bool RestrictMetadata
        {
            get; set;
        }
        public bool RestrictPurchase
        {
            get; set;
        }
        ...
        public string[] RatingDisclaimers
        {
            get; set;
        }
        ...
        public object[] RatingDescriptorLogoUrls
        {
            get; set;
        }
    }
    ...
    public class Alternateid
    {
        ...
        public string AlternatedIdTypeString
        {
            get; set;
        }
    }
